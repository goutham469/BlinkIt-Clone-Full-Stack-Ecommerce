...
const ProductListPage = () => {
  ...
  async function getMobileProductData() {
    let data = await fetch(`${baseURL}/api/product/get-product-by-category-mobile`, {
      method: 'post',
          ...
          <div className='min-h-[88vh] max-h-[88vh] overflow-y-scroll shadow-md scrollbarCustom bg-white py-2'>
            {DisplaySubCatory.map((s, index) => {
              ...
              return (
                ...
                >
                  {
                    innerWidth>"1022"&&<div className='  rounded box-border'>
                      <img
                        src={s.image}
                        alt='subCategory'
                  ...
                  {
                    innerWidth>"1022"?<p className='text-xl text-center lg:text-left lg:text-base m-3'>{s.name}</p>
                    :
